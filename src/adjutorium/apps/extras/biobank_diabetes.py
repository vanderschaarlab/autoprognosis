...
# adjutorium absolute
from adjutorium.plugins.prediction.risk_estimation.benchmarks.diabetes.ada.model import (
    ADAModel,
)
from adjutorium.plugins.prediction.risk_estimation.benchmarks.diabetes.diabetes_uk.model import (
    DiabetesUKModel,
)
from adjutorium.plugins.prediction.risk_estimation.benchmarks.diabetes.finrisk.model import (
    FINRISKModel,
)
