...
from autoprognosis.plugins.prediction.classifiers.plugin_bernoulli_naive_bayes import (
    plugin,
)
...
def from_api() -> PredictionPlugin:
    return Predictions().get("bernoulli_naive_bayes")
...
def test_bernoulli_naive_bayes_plugin_sanity(test_plugin: PredictionPlugin) -> None:
...
def test_bernoulli_naive_bayes_plugin_name(test_plugin: PredictionPlugin) -> None:
    assert test_plugin.name() == "bernoulli_naive_bayes"


@pytest.mark.parametrize(
    "test_plugin", [from_api(), from_module(), from_serde(), from_pickle()]
)
def test_bernoulli_naive_bayes_plugin_type(test_plugin: PredictionPlugin) -> None:
...
def test_bernoulli_naive_bayes_plugin_hyperparams(
...
def test_bernoulli_naive_bayes_plugin_fit_predict(
    test_plugin: PredictionPlugin,
) -> None:
